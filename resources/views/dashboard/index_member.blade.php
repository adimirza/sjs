      ...
      <div class="card">
        <div class="card-body profile-card  d-flex flex-column align-items-left">
          ...
          <div class="progress mt-3">
            <div class="progress-bar" role="progressbar" style="width: {{ $jml_umum ? ($jml_paham_divisi/$jml_divisi)*100 : 0 }}%" aria-valuenow="{{ $jml_paham_divisi }}" aria-valuemin="0" aria-valuemax="100">{{ $jml_paham_divisi }}/{{ $jml_divisi }}</div>
          </div>
          <p>SE Divisi</p>
        </div>
      </div>
